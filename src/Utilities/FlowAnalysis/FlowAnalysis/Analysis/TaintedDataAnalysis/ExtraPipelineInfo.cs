...
//    /// </summary>
//    internal sealed class ExtraPipelineInfo : ITaintedDataInfo, IEquatable<ExtraPipelineInfo>
//    {
//        public ExtraPipelineInfo(string fullTypeName, bool isInterface, bool isConstructorSanitizing, ImmutableHashSet<string> sanitizingMethods, ImmutableHashSet<string> sanitizingInstanceMethods)
//        {
...
//        /// <summary>
//        /// Indicates that this <see cref="ExtraPipelineInfo"/> uses <see cref="ValueContentAbstractValue"/>s.
//        /// </summary>
...
//        {
//            return obj is ExtraPipelineInfo other ? this.Equals(other) : false;
//        }

//        public bool Equals(ExtraPipelineInfo other)
//        {
//            return other != null
